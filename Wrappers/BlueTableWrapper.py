...
class BlueTableWrapper(BaseWrapper):
    ...
    # PDG: Added 20251106 **kwargs in next 2 lines for compatibility with gymnasium in cyborg_plus_plus
    ...
    def _interpret_connections(self, activity: list):
        ...
        # PDG: 20251106 Commented out below block and added block after that 
        # from cyborg_plus_plus to reflect bug fixes made there
